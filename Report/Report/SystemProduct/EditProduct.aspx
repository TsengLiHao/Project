<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="EditProduct.aspx.cs" Inherits="Report.SystemAdmin.EditProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <style>
        ...
        <div id="divText" align="center">
            ...
            <asp:Label ID="Label6" runat="server" CssClass="lbl" Text="其他商品資訊:"></asp:Label>
            <asp:TextBox ID="txtInfo"  runat="server" CssClass="txt" TextMode="MultiLine"></asp:TextBox><br />
            <asp:Label ID="Label7" runat="server" CssClass="lbl" Text="商品狀態:"></asp:Label>
            ...
            <asp:Label ID="Label8" runat="server" CssClass="lbl" Text="商品照:"></asp:Label>
